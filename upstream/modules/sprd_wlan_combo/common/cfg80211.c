				...
				struct cfg80211_ap_update *info)
{
	...
	return cfg80211_set_beacon_ies(vif, &info->beacon);
}
...
int sprd_cfg80211_set_wiphy_params(struct wiphy *wiphy, int radio_idx, u32 changed)
{
	struct sprd_priv *priv = wiphy_priv(wiphy);
	u16 rts = 0, frag = 0;
